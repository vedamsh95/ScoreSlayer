 ...
 */
export default function SpadesVariantDetail() {
...
const styles = StyleSheet.create({
  ...
  errContainer: { flex: 1, alignItems: "center", justifyContent: "center", backgroundColor: "#150428" },
  ...
  bottomBar: {
    ...
    backgroundColor: "rgba(21,4,40,0.97)",
